...
abstract class TrackAsiaGlPlatform {
  ...
  static TrackAsiaGlPlatform Function() createInstance = () => MethodChannelTrackAsiaGl();
  ...
  Widget buildView(
      Map<String, dynamic> creationParams, OnPlatformViewCreatedCallback onPlatformViewCreated, Set<Factory<OneSequenceGestureRecognizer>>? gestureRecognizers);
